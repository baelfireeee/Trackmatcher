<div class="RIASEC6">
							...
							<?php
										   include("dbConfig.php");
											  ...
											  $sql = "SELECT * FROM `test` WHERE `testLanguage_id` LIKE '%2%' and `test_code` = 'R6' ";
							...
							<?php
										   include("dbConfig.php");
											  ...
											  $sql = "SELECT * FROM `test` WHERE `testLanguage_id` LIKE '%2%' and `test_code` = 'I6' ";
											  $result = mysqli_query($db,$sql);
											   while($results = mysqli_fetch_assoc($result)){
							...
							<?php
										   include("dbConfig.php");
											  ...
											  $sql = "SELECT * FROM `test` WHERE `testLanguage_id` LIKE '%2%' and `test_code` = 'A6' ";
											  $result = mysqli_query($db,$sql);
											   while($results = mysqli_fetch_assoc($result)){
							...
							<?php
										   include("dbConfig.php");
											$R1 = "R1";
											  $sql = "SELECT * FROM `test` WHERE `testLanguage_id` LIKE '%2%' and `test_code` = 'S6' ";
											  $result = mysqli_query($db,$sql);
											   while($results = mysqli_fetch_assoc($result)){
							...
							<?php
										   include("dbConfig.php");
											  ...
											  $sql = "SELECT * FROM `test` WHERE `testLanguage_id` LIKE '%2%' and `test_code` = 'E6' ";
											  $result = mysqli_query($db,$sql);
											   while($results = mysqli_fetch_assoc($result)){
							...
							<?php
										   include("dbConfig.php");
											  ...
											  $sql = "SELECT * FROM `test` WHERE `testLanguage_id` LIKE '%2%' and `test_code` = 'C6' ";
											  $result = mysqli_query($db,$sql);
											   while($results = mysqli_fetch_assoc($result)){
