			...
			<div class="col-sm-6 col-lg-offset-3">
					...
					<form action="../../loginprocess.php" method="post">
							<div class="logincontainer" style="margin-left:35px; margin-right:35px; margin-top:40px">
									...
									<div class="footercontainer" style="background-color:#fff; margin-bottom: 20px"></br>
                ...
                <div class="row">
                    ...
                    <div class="footer-col col-md-4">
                        ...
                        <ul class="list-inline">
                            ...
                            <li>
                                <a href="https://twitter.com/trackmatcher" class="btn-social btn-outline"><i class="fa fa-fw fa-twitter"></i></a>
                            </li>
