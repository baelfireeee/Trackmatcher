<div class="RIASEC2">
							...
							<?php
										   include("dbConfig.php");
											  ...
											  $sql = "SELECT * FROM `test` WHERE `testLanguage_id` LIKE '%2%' and `test_code` = 'R2' ";
							...
							<?php
										   include("dbConfig.php");
											  ...
											  $sql = "SELECT * FROM `test` WHERE `testLanguage_id` LIKE '%2%' and `test_code` = 'I2' ";
											  $result = mysqli_query($db,$sql);
											   while($results = mysqli_fetch_assoc($result)){
							...
							<?php
										   include("dbConfig.php");
											  ...
											  $sql = "SELECT * FROM `test` WHERE `testLanguage_id` LIKE '%2%' and `test_code` = 'A2' ";
											  $result = mysqli_query($db,$sql);
											   while($results = mysqli_fetch_assoc($result)){
							...
							<?php
										   include("dbConfig.php");
											$R1 = "R1";
											  $sql = "SELECT * FROM `test` WHERE `testLanguage_id` LIKE '%2%' and `test_code` = 'S2' ";
											  $result = mysqli_query($db,$sql);
											   while($results = mysqli_fetch_assoc($result)){
							...
							<?php
										   include("dbConfig.php");
											  ...
											  $sql = "SELECT * FROM `test` WHERE `testLanguage_id` LIKE '%2%' and `test_code` = 'E2' ";
											  $result = mysqli_query($db,$sql);
											   while($results = mysqli_fetch_assoc($result)){
							...
							<?php
										   include("dbConfig.php");
											  ...
											  $sql = "SELECT * FROM `test` WHERE `testLanguage_id` LIKE '%2%' and `test_code` = 'C2' ";
											  $result = mysqli_query($db,$sql);
											   while($results = mysqli_fetch_assoc($result)){
