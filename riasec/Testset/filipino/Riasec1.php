...
<div class="RIASEC1">
							...
							<?php
										   include("dbConfig.php");
											  ...
											  $sql = "SELECT * FROM `test` WHERE `testLanguage_id` LIKE '%2%' and `test_code` = 'R1' ";
								...
								<td name="<?php echo $_POST[tcoder1];?>" style="text-align: center"><?php echo $tquestR1;?></td>
							...
							<?php
										   include("dbConfig.php");
											  ...
											  $sql = "SELECT * FROM `test` WHERE `testLanguage_id` LIKE '%2%' and `test_code` = 'I1' ";
											  $result = mysqli_query($db,$sql);
											   while($results = mysqli_fetch_assoc($result)){
							...
							<?php
										   include("dbConfig.php");
											  ...
											  $sql = "SELECT * FROM `test` WHERE `testLanguage_id` LIKE '%2%' and `test_code` = 'A1' ";
											  $result = mysqli_query($db,$sql);
											   while($results = mysqli_fetch_assoc($result)){
							...
							<?php
										   include("dbConfig.php");
											$R1 = "R1";
											  $sql = "SELECT * FROM `test` WHERE `testLanguage_id` LIKE '%2%' and `test_code` = 'S1' ";
											  $result = mysqli_query($db,$sql);
											   while($results = mysqli_fetch_assoc($result)){
							...
							<?php
										   include("dbConfig.php");
											  ...
											  $sql = "SELECT * FROM `test` WHERE `testLanguage_id` LIKE '%2%' and `test_code` = 'E1' ";
											  $result = mysqli_query($db,$sql);
											   while($results = mysqli_fetch_assoc($result)){
							...
							<?php
										   include("dbConfig.php");
											  ...
											  $sql = "SELECT * FROM `test` WHERE `testLanguage_id` LIKE '%2%' and `test_code` = 'C1' ";
											  $result = mysqli_query($db,$sql);
											   while($results = mysqli_fetch_assoc($result)){
