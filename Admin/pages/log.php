					...
					<div class="row">
							...
							<div class="col-sm-12 portfolio-item">
								<div class="panel panel-default">
								  ...
								  <div class="panel-heading" style="text-align: center"><h4>LOGS</h4></div>
								  ...
								  <table class="table table-striped table-bordered table-hover">
									...
									<tr>
										...
										<th style="color: #06356f; text-align: center">Log ID</th>
										<th style="color: #06356f; text-align: center">Action</th>
										<th style="color: #06356f; text-align: center">Admin ID</th>
										<th style="color: #06356f; text-align: center">Table Name</th>
										<th style="color: #06356f; text-align: center">Table ID</th>
										<th style="color: #06356f; text-align: center">Date</th>
									...
									<?php
										   ...
										   $page=$_GET["page"];
											  ...
											  $sql = "SELECT * FROM `log` ORDER BY `date_and_time` DESC LIMIT $page1,15";
											  $result = mysqli_query($db,$sql);
											   while($results = mysqli_fetch_assoc($result)){
											 
											echo "<tbody>";
											echo "<tr>";
											  echo "<th  style='text-align: center'>".$results['id']."</th>";
											  echo "<th  style='text-align: center'>".$results['action']."</th>";
											  echo "<th  style='text-align: center'>".$results['admin_id']."</th>";
											  echo "<th  style='text-align: center'>".$results['table_name']."</th>";
											  echo "<th  style='text-align: center'>".$results['table_id']."</th>";
											  echo "<th  style='text-align: center'>".$results['date_and_time']."</th>";
								...
								<ul class="pagination pagination-lg" style="position: absolute; right: 20px;" >
										...
										<?php
										$res1 = mysqli_query($db,"SELECT * From log");
											...
											$a = ceil($a);
												...
												for($b=1;$b<=$a;$b++){
													echo "<li><a href='log.php?page=".$b."'>".$b.'  '."</a></li>";
												}
