...
<li>
          ...
          <div id="content">
			...
			<div id="page-wrapper">
					<div class="row">
									<div class="col-lg-12">
										<h1 class="page-header">RIASEC</h1>
									</div>
									<!-- /.col-lg-12 -->
								</div>
							...
							<div class="col-sm-12 portfolio-item">
								<div class="panel panel-red">
								  ...
								  <div class="panel-heading" style="text-align: center"><h4>LIST OF RIASEC Defined</h4></div>
								  ...
								  <table class="table table-striped table-bordered table-hover">
									...
									<tr>
										...
										<th style="color: #06356f; text-align: center">RIASEC Defined</th>
									...
									<?php
										   include("../../dbConfig.php");
											  ...
											  $sql = "SELECT * FROM `riasec` ORDER BY `riasec_id` ASC";
											  $result = mysqli_query($db,$sql);
											   while($results = mysqli_fetch_assoc($result)){
											  echo "<tbody>";
											  echo "<tr><form action=othersprocess/updateriasec.php method=post>";
							
											  echo "<th>".$results['riasec_id']."</th>";
											  echo "<th><textarea type=text name=riasecname value='".$results['riasec_name']."' style='width: 100%; height: 40px'>".$results['riasec_name']."</textarea></th>";
											  echo "<th><textarea type=text name=riasecdefined value='".$results['riasec_defined']."' style='width: 100%; height: 40px'>".$results['riasec_defined']."</textarea></th>";
											  
											  echo "<th>".$results['admin_id']."</th>";
											  echo "<th>".$results['date_and_time']."</th>";
											  
											  echo "<input type=hidden name=riasecid value='".$results['riasec_id']."'/>";
