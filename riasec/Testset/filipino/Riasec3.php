<div class="RIASEC3">
							...
							<?php
										   include("dbConfig.php");
											  ...
											  $sql = "SELECT * FROM `test` WHERE `testLanguage_id` LIKE '%2%' and `test_code` = 'R3' ";
							...
							<?php
										   include("dbConfig.php");
											  ...
											  $sql = "SELECT * FROM `test` WHERE `testLanguage_id` LIKE '%2%' and `test_code` = 'I3' ";
											  $result = mysqli_query($db,$sql);
											   while($results = mysqli_fetch_assoc($result)){
							...
							<?php
										   include("dbConfig.php");
											  ...
											  $sql = "SELECT * FROM `test` WHERE `testLanguage_id` LIKE '%2%' and `test_code` = 'A3' ";
											  $result = mysqli_query($db,$sql);
											   while($results = mysqli_fetch_assoc($result)){
							...
							<?php
										   include("dbConfig.php");
											$R1 = "R1";
											  $sql = "SELECT * FROM `test` WHERE `testLanguage_id` LIKE '%2%' and `test_code` = 'S3' ";
											  $result = mysqli_query($db,$sql);
											   while($results = mysqli_fetch_assoc($result)){
							...
							<?php
										   include("dbConfig.php");
											  ...
											  $sql = "SELECT * FROM `test` WHERE `testLanguage_id` LIKE '%2%' and `test_code` = 'E3' ";
											  $result = mysqli_query($db,$sql);
											   while($results = mysqli_fetch_assoc($result)){
							...
							<?php
										   include("dbConfig.php");
											  ...
											  $sql = "SELECT * FROM `test` WHERE `testLanguage_id` LIKE '%2%' and `test_code` = 'C3' ";
											  $result = mysqli_query($db,$sql);
											   while($results = mysqli_fetch_assoc($result)){
